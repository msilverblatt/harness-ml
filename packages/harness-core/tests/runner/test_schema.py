...
class TestDeclarativeFeatureSchemas:
    ...
    def test_pairwise_mode_enum(self):
        from harnessml.core.runner.schema import PairwiseMode
    ...
    def test_feature_store_config_defaults(self):
        from harnessml.core.runner.schema import FeatureStoreConfig
    ...
    def test_data_config_feature_store(self):
        from harnessml.core.runner.schema import DataConfig, FeatureDef, FeatureType
        dc = DataConfig(
            feature_defs={
