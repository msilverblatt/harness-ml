...
class TestModelsDispatch:
    ...
    def _dispatch(self, **kwargs):
        from easyml.plugin.handlers.models import dispatch
        defaults = dict(
    ...
    def test_all_actions_registered(self):
        from easyml.plugin.handlers.models import ACTIONS
        expected = {
    ...
    def test_dispatch_routes_to_add(self):
        from easyml.plugin.handlers import models
...
class TestDataDispatch:
    ...
    def _dispatch(self, **kwargs):
        from easyml.plugin.handlers.data import dispatch
        defaults = dict(
    ...
    def test_all_actions_registered(self):
        from easyml.plugin.handlers.data import ACTIONS
        expected = {
    ...
    def test_dispatch_routes_to_add(self):
        from easyml.plugin.handlers import data
...
class TestConfigDispatch:
    ...
    def _dispatch(self, **kwargs):
        from easyml.plugin.handlers.config import dispatch
        defaults = dict(
    ...
    def test_all_actions_registered(self):
        from easyml.plugin.handlers.config import ACTIONS
        expected = {
    ...
    def test_dispatch_routes_to_show(self):
        from easyml.plugin.handlers import config
...
class TestPipelineDispatch:
    ...
    def _dispatch(self, **kwargs):
        from easyml.plugin.handlers.pipeline import dispatch
        defaults = dict(
    ...
    def test_all_actions_registered(self):
        from easyml.plugin.handlers.pipeline import ACTIONS
        expected = {
    ...
    def test_dispatch_routes_to_list_runs(self):
        from easyml.plugin.handlers import pipeline
