...
from easyml.core.runner.feature_cache import FeatureCache, CacheEntry


class TestCacheEntry:
    def test_create_entry(self):
        entry = CacheEntry(
            cache_key="abc123", path="team/adj_em.parquet",
            feature_type="team", source="kenpom",
        )
    ...
    def test_entry_with_derivatives(self):
        entry = CacheEntry(
            cache_key="abc123", path="team/adj_em.parquet",
            feature_type="team", derivatives=["diff_adj_em", "ratio_adj_em"],
        )
