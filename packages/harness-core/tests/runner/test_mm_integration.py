"""Integration tests validating mm pipeline config through harness-runner.
...
class TestMmConfigValidates:
    """The mm pipeline's actual config must validate through harness-runner."""
...
class TestAllExportsImportable:
    """Verify all public symbols are importable from harnessml.core.runner."""
    ...
    def test_run_manager_importable(self):
        from harnessml.core.runner import RunManager
    ...
    def test_pipeline_runner_importable(self):
        from harnessml.core.runner import PipelineRunner
    ...
    def test_validator_importable(self):
        from harnessml.core.runner import ValidationResult, validate_project
