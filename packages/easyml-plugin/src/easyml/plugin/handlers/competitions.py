...
def _handle_create(*, config, name=None, **_kwargs):
    ...
    from easyml.sports.competitions.schemas import CompetitionConfig
...
def _handle_confidence(*, name=None, **_kwargs):
    ...
    from easyml.sports.competitions.confidence import compute_model_disagreement
...
def _handle_export(*, name=None, output_dir=None, format_type=None, **_kwargs):
    ...
    from easyml.sports.competitions.export import export_json
    ...
    if fmt == "json":
        ...
        from easyml.sports.competitions.export import export_bracket_markdown
        if structure is None:
        ...
        from easyml.sports.competitions.export import export_csv
...
def _handle_list_strategies(**_kwargs):
    ...
    from easyml.sports.competitions.optimizer import BUILTIN_STRATEGIES
